                            ...
                            <div class="mb-3">
                                ...
                                <div class="">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="available_currency[]" type="checkbox" id="inlineCheckbox1" value="USD" {{in_array('USD',$payment->available_currency) ? 'checked' : ''}}>
                                        <label class="form-check-label" for="inlineCheckbox1">USD</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="available_currency[]" type="checkbox" id="inlineCheckbox2" value="BAHT" {{in_array('BAHT',$payment->available_currency) ? 'checked' : ''}}>
                                        <label class="form-check-label" for="inlineCheckbox2">BAHT</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="available_currency[]" type="checkbox" id="inlineCheckbox3" value="MMK" {{in_array('MMK',$payment->available_currency) ? 'checked' : ''}}>
